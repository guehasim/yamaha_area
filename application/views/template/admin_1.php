...
<head>
    ...
    <link href="<?php echo base_url() ?>assets/assets/css/ct-paper.css" rel="stylesheet"/>
    <link href="<?php echo base_url() ?>assets/assets/css/demo.css" rel="stylesheet" /> 
    <link href="<?php echo base_url() ?>assets/assets/css/examples.css" rel="stylesheet" />
    <link href="<?php echo base_url() ?>assets/login/vendor_plugins/datepicker/css/datepicker.css" rel="stylesheet" />
        
    <!--     Fonts and icons     -->
    <link href="<?php echo base_url() ?>assets/assets/font-awesome-4.7.0/css/font-awesome.min.css" rel="stylesheet">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navigation-example-2">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li>
                <a href="<?php echo base_url(); ?>pic_admin">PIC</a>
            </li>
            <li>
                <a href="<?php echo base_url(); ?>admin">ADMIN</a>
            </li>
            <li>
                <a href="<?php echo base_url(); ?>log">AKTIVITAS</a>
            </li>
