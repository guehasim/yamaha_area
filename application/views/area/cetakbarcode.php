...
<body>
    <div class="page">
        ...
        <div style="text-align:center; font-size:15px">
            <h1 style="background:#0f187d;color:#FFFFFF">AREA <?php echo $ad->nama;?></h1>
        </div>
        <div style="text-align:center;">
            <img src='<?php echo base_url(); ?>assets/images/<?php echo $ad->qrcode;?>' style="width:300px;height:300px;">
        </div>
        <div>
